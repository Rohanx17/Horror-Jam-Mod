...
define G1 = Character(_('Goon'), base, color="#263658", who_outlines=[(gui.name_text_thickness, '#000000')]) ##401c0a #[G1_Name]
define G2 = Character(_('Goon'), base, color="#75382b", who_outlines=[(gui.name_text_thickness, '#000000')]) #40130a #[G2_Name]

default G1_Name = 'Goon' #short
default G2_Name = 'Goon' #tall
...
image anonBackpack = Image(bitnCgs+"anon backpack.png")
image carArgue = Image(bitnCgs+"car argue.png")
image trishEnd = Image(bitnCgs+"alt scene.png")
...
define af_wtf = bitnEffects+"surprise.mp3" 
...
define cornered = bitnEffects+"Cornered.mp3"
define laughTrack = bitnEffects+"Laugh track.mp3"
define whipCrack = bitnEffects+"Whip crack.mp3"
define glassBreaking = bitnEffects+"Glass_breaking.ogg"
define phoneBuzz = bitnEffects+"phone_buzz.mp3"
define doorOpenClose = bitnEffects+"door_open_close.mp3"
