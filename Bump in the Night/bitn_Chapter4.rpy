label bitn_Chapter4:
    ...
    F "So this is it then? We're all going to die because you just couldn't keep it in your fucking pants. Way to go dweeb."
    A "For christsakes are you still on about that!? You were the one that wanted to push our luck tonight and get us in trouble, not me."
    F "Only because of your prank, which I was right about by the way!{nw}" #[have line be interrupted at end]
    T "WILL YOU TWO SHUT THE FUCK UP!"
    "We’re stunned into silence, Trish continues barely holding it together."
    T "This is both your faults!"
    T "Anon you're always getting into trouble with your stupid antics, because you never think about any of the consequences of your bullshit. It's like you don't care what happens or who you hurt so long as you think it's fucking funny."
    T "And Fang you're always enabling him! Whenever he pushes the line on anything you're right there to cheer him on. You're probably the most stubborn person I've ever met. If you had taken a moment to consider the thoughts of anyone besides yourself, we wouldn't be here right now."
    "She starts to sob again."
    T "What's my family going to do without me? Riley sure as hell can't manage them all. I'm never going to see any of them again and it's all your fault! The least you two could do is not spend our final moments arguing!"
    "We sit there quietly for awhile, taking in her words. As much as I hate to admit it, she's right."
    A "...I'm sorry guys, I didn't check out the place before we came, just googled haunted places in VB and took down the address. It just seemed so perfect all I could think about was the look on your faces once it was over. It never crossed my mind anything like this could happen."
    F "No, she's right, you all were. I knew I had fucked up as soon as we found their stash I just couldn't bear to admit it. If we had just left when you asked we would have been fine, god why would there even be a locked door in a place that old?"
    A "Yeah but I shouldn't have been egging you on to think the place was haunted. You wouldn't have felt the need to prove me wrong if I never gave you a reason too."
    F "Dammit dweeb, that's bullshit and you know it. I would have found some other excuse to drag us down there I'm sure."
    A "Not if I had just came clean from the start."
    "Suddenly Reed interjects, his voice sullen and defeated."
    Re "No, this is my fault."
    Re "I'm the one that made Anon’s plan possible and drove us there without knowing what we were getting into. I let Fang drag us around instead of putting my foot down and getting out of there."
    Re "I knew it wasn't a good idea, but instead of doing anything about it I just stood around and watched it all happen, like I always fucking do."
    "He drops his head."
    Re "God, why am I like this?"
    A "Come on man, you know that's not true. We have a little time before they get back. Maybe we can cook up a story they'll buy?"
    "Reed laughs cynically."
    Re "You really think they're going to let us go at this point? We were fucked the second they caught us. Sorry dude but..."
    Re "...this is it."
    "It takes a moment to process his rather sobering statement. Try as I might, I really can't refute it. I turn to Fang and whisper in her direction."
    A "I love you Fang, I'm... so sorry it had to end this way."
    F "...Well, if I have to go, I'm glad I don't have to face it alone at least. There's no one else I'd rather spend my last moments with than my dweeb."
    "Her confession warms my heart, and I reach out my hand to find hers. We connect, the warmth of her scales now the only light I have in this desolate place."
    A "Me neither. One last kiss for the road?"
    F "Sure."
    "I crane out my neck until I bump into her snoot. We're only just barely able to close the distance to touch at all, but I’d say it was the best one I'd ever had."
    "As I pull my head away I can hear footsteps off in the distance, squeezing her hand tighter as I do. If it has to end here then so be it. Honestly, until I met Fang I wasn't expecting I'd make it that far anyway. At least now I can die knowing what it meant to live." 
    ...
    goon "Alright ya maggots! My men tell me you thought you could interfere with one of my operations and live to tell about it! Now spill or I'm going to beat your face in so badly your own motha won't recognize ya!"
    "We're all speechless as the figure takes command of the room, we brace ourselves for what's to come."
    goon "Hey one of youse get the lights I'm not a bat!"
    "The lights flicker back on and I can hardly believe my eyes."
    ...
    "It's Moe, Uncle Moe, so long as my eyes aren't playing tricks on me. The second he notices it's us he freezes."

    #[switch moe to Shocked]
    show moe shocked flip with dissolve

    "His face goes pale and he drops the iron rod he was beating across his palm."

    #[play metal clang sound]
    play sound pipeDrop

    "The metal clang against the floor quickly swallowed by our incredulous silence."
    Moe "Lucy, is that you?"
    F "...Uncle Moe!?"
    "He grabs his head and I can see the years of his life peel off though his worried expression, quietly cursing to himself."
    ...
    "He turns around and grabs the shorter goon by his collar and promptly drags him into a nearby room."
    ...
    play music arguing loop volume 4
    pause 3
    ...
    "Suddenly the room goes quiet. We're all stunned in silence, even the goon left outside is starting to sweat."
    ...
    "The door swings open, and Moe strolls out towards Fang, his apron covered in fresh marinara."
    ...
    Moe "Oh my little Lucy, are you alright? What did they do to you?"
    "Still a little shell shocked she stutters back as best she can."
    F "Uh...I-I'm alright, I think...but Reed-"

    #[move moe very close to the camera, shift sprite to stained/neutral]
    show moe neutral bloodstain flip:
        linear 1 zoom 2 ycenter 1.25

    "He picks her up chair and all, and squeezes for dear life. The relief nearly reshapes his face."
    Moe "Oh thank God! In that case, I think we're all gonna make it out just fine."
    F "...That's great Moe but uh... Reeds hand-"

    #[moe steps back to normal distance]
    show moe neutral bloodstain flip:
        linear 1 zoom 1 ycenter 0.655

    "He puts her down, and looks over at reed to assess the damage."
    Moe "Ah yes."
    ...
    "He turns around and gestures at the goon."
    Moe "What's your name Picciotto?"
    G2 "B-B-B-Bruce sir."
    "he barely squeaks out, quaking in his boots."
    Moe "Alright Deuce, go put the limbs on ice and take the boy downtown. Ring Dr. Quale before you get there and he'll take care of the rest."
    G2 "Actually, my name is-{nw}" #[do the forced text cutoff thing]
    ...
    G2 "N-N-No sir, right away, sir!"
    "With a panicked expression, he leaps into action. Scooping up the goods and leading a disoriented Reed away like he was a porcelain doll."
    ...
    "Moe wastes no time taking a knife off the table and severing our bonds, once we get our bearings he leads us back into the world above."
    
    #[cut to moe car cg 1, play driving sounds loud and moe theme quiet]
    show moeCar1 with Dissolve(2)
    play music venetianValues fadein 2 volume 0.25
    play sound insideCarNoise fadein 2 volume 1 loop

    A "...Uh, thanks again for the save Moe."
    Moe "Don't worry about it. Now one more time, if anyone asks what happened tonight what's the story you're going to tell them?"
    A "We were out joyriding after leaving Stella's Halloween party. Reed totaled his van and since you were nearby, we called you for help. We had a nice evening together and lost track of time before you drove us home."
    Moe "Correct."
...
label bitn_chapter4_trish_dialogue:
    ...
    Moe "Well, the boys were telling you the truth, good help is hard to find these days."
    ...
    Moe "Stop by the old place when you have a chance. I'm sure I can find something for you to do." #[this’ll trigger a cg in the credits where she’s washing dishes in moe’s kitchen lol]
    "The air is stained in silence until Fang breaks the ice."
    jump bitn_chapter4_continue
    #///////////////////////////////////////////////////////////////

label bitn_chapter4_continue:
    F "So... you're really not going to tell mom and dad?"
    Moe "Of course not, just stay out of trouble and this'll be our little secret ok?"
    T "I don't get it, you're really gonna let us go, just like that?"
    "He chuckles."
    ...
    Moe "In our way of life, the most important thing in this world is trust. For the sake of my little Lucy, I've chosen to trust that you kids have enough sense to not do anything foolish. It would be a great shame to find out that trust was... misplaced. We know where you live after all..."
    ...
    Moe "Good, that's what I like to hear. Because if this happens again, then next time you won't be so lucky. Do I make myself clear?"
    A "Crystal sir."

    #[switch to moe cg 1]
    show moeCar1

    Moe "Good, I believe this is your stop lovebirds. Have a good night and tell Ol' Rip I said hello!"
    F "...Will do."
    ...
    "We disembark and say our goodbyes, as Moe takes off into the distance with a very distressed Triceratops in tow. I check the time on my phone."
    A "Well I doubt the bus runs this late, so I'll go phone a ride."
    
    #[switch fang to happy]
    show fang happy flip
    with dissolve

    F "If you weren't planning to stay, why'd you get out?"
    
    #[switch anon to concerned]
    show anon concerned
    with dissolve

    A "I...think I'll be keeping my distance from Moe for a while."
    ...
    A "Anyway, sorry about tonight and all."
    
    #[switch fang to happy]
    show fang happy flip
    with dissolve

    F "You're fine, wasn't the worst place we've snuck off to go drink."
    ...
    F "Well, maybe not, but... all's well that ends well?"
    ...
    A "Anyway, I think it's about time we call a truce before someone ends up getting killed for real."
    F "Agreed, I was getting kinda bored of it anyway."
    A "Awesome, ...so what do you want to do next week?"
    
    #[switch fang to considering]
    show fang considering flip
    with dissolve

    F "mmm, we could go see a movie?"
    ...
    scene black
    with Dissolve(4)
    "I whip out my phone and look for a thread to derail to pass the time. I stare at it for a moment before deciding to close the tab out entirely."
    "Instead I check the local AMC showtimes to see if there's anything worth seeing. There's a neat little documentary about famous roadside attractions."
    "I'll see if Fang is game for that tomorrow."
    "A few minutes later a certain taxi who I swear follows me around pulls up. I get in and have him take me straight home. I think that's enough excitement for one lifetime."
    "..."
    "THE END..."
    return